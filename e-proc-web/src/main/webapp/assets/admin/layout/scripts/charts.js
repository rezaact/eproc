$(document).ready(function(){        
    ...
    if($("#dash_chart_1").length > 0){
        ...
        var data  = [ [1, 25], [2, 28], [3, 22], [4, 18], [5, 30], [6, 18], [7,14], [8,16] ];        
    ...
    if($("#dash_chart_2").length > 0){
        ...
        var data1  = [ [1, 1023], [2, 1244], [3, 1506], [4, 1330], [5, 1065], [6, 890], [7,650], [8,1450], [9,1350], [10,1550], [11,1650], [12,1550] ];
        //var data2  = [ [1, 868], [2, 1485], [3, 1355], [4, 1002], [5, 1200], [6, 755], [7,800],[8,900],[9,800],[10,700],[11,1100],[12,1200] ];
        
        //var dash_chart_2 = $.plot($("#dash_chart_2"), [{ data: data1, label: "Search Traffic"},{data: data2, label: "Referal Traffic"}],{ 
        var dash_chart_2 = $.plot($("#dash_chart_2"), [{ data: data1, label: "Search Traffic"}],{ 
                                  series: {lines: { show: true }, points: { show: true }},
    ...
    if($("#chart_bar_1").length > 0){
        ...
        var data1 = [ [1, 25], [2, 28], [3, 22], [4, 18], [5, 30], [6, 18], [7, 38], [8, 22], [9, 38], [10, 23], [11, 25], [12, 34] ];
        ...
        var chart_bar_1 = $.plot($("#chart_bar_1"), [ { data: data1, label: "Data 1" }], {                                   
    ...
    if($("#chart_pie_1").length > 0){
        ...
        var data = [];            
            data[0] = { label: "Pengadaan Barang", data: 40 };
            data[1] = { label: "Jasa Konsultasi Badan Usaha", data: 10 };
            data[2] = { label: "Jasa Konsultasi Perseorangan", data: 5 };
            data[3] = { label: "Pekerjaan Konstruksi", data: 15 };
            data[4] = { label: "Jasa Lainnya", data: 30 };
