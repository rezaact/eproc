...
<div class="col-md-12" id="pengumuman_list_data">
    ...
    $(document).ready(
        function() {
            ...
            $(".btn_kembali").click(function(e) {
                e.preventDefault();
                $("#pengumuman_list_data").show("slow");
                $(".form_detail_parent_jasa").hide();
                $(".form_detail_parent_material").hide();
                $(".form_detail_child_jasa").hide();
                $(".form_detail_child_material").hide();
