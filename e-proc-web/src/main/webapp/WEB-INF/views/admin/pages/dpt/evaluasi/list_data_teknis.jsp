<%-- 
    Document   : list_data_teknis
    Created on : Oct 8, 2015, 1:42:21 PM
    Author     : Stefu
--%>
...
<div class="col-md-12" id="list_data_teknis">
                    ...
                    <table id="evaluasi_table" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Evaluasi</td>
                                <td align="center">     
                                    <a class="widget-icon widget-icon-dark detail_teknis" data-detail="1"><span class="icon-zoom-in"></span></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
...
<tiles:insertAttribute name="detail_teknis"/>
...
<script language="JavaScript" type="text/javascript">
    $(document).ready(
        function() {
            ...
            $('.detail_teknis').click(function(){
            var me =this;
            console.log('detail', $(me).data('detail'));

            $(".form_detail_teknis").show("slow");
