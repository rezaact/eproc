...
<!--START HTML-->
<!-- START LIST -->
<div class="col-md-12" id="master_wilayah_list">
    <div class="block block-fill-white">
        <div class="header" style="background-color:SteelBlue;"><h2 style="color:white;font-size:14px">Master Unit</h2>
            <div class="pull-right"><a id="master_wilayah_list_btnadd" class="btn btn-success">
                ...
                <div class="col-md-12">
                    <table id="example1" cellpadding="0" cellspacing="0" width="100%" class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>Ya</td>
                            <td align="center">
                                <a href="#" class="widget-icon widget-icon-dark master_wilayah_list_btnedit"><span class="icon-pencil"></span></a>
                                <a href="#master_wilayah_modal_delete" data-toggle="modal" class="widget-icon widget-icon-dark"><span class="icon-trash"></span></a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<!-- START FORM TAMBAH -->
<div class="col-md-12" id="master_wilayah_form_add" style="display: none">
    <div class="block block-fill-white">
        <div class="panelx panel-info">
            <div class="panel-heading"><h3 class="panel-title">TAMBAH DATA WILAYAH</h3>
            </div>
            <form method="post" action="#">
                <div class="panel-body">
                    <div class="content controls">
                        <div class="form-row">
                            <div class="col-md-2">ID Wilayah</div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                ...
                                <button  class="btn btn-danger master_wilayah_form_add_btncancel"><span class="icon-repeat"></span> Kembali</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--END FORM TAMBAH -->
<!-- START FORM EDIT -->
<div class="col-md-12" id="master_wilayah_form_edit" style="display: none">
    <div class="block block-fill-white">
        <div class="panelx panel-info">
            <div class="panel-heading"><h3 class="panel-title">PERBAHARUI DATA WILAYAH</h3>
            </div>
            <form method="post" action="#">
                <div class="panel-body">
                    <div class="content controls">
                        ...
                        <div class="form-row">
                            <div class="col-md-2">Nama</div>
                            <div class="col-md-2">
                                <input type="text" maxlength="30" class="form-control" value="Wilayah 1"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">Alamat</div>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">Email</div>
                            <div class="col-md-2">
                                <input type="text" maxlength="30" class="form-control" value="wilayah1@corporate.co.id"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">Pimpinan</div>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">Homepage</div>
                            <div class="col-md-2">
                                <input type="text" maxlength="30" class="form-control" value="http://www.wilayah1.co.id"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">Status</div>
...
<!--START HTML MODAL-->
<div class="modal" id="master_wilayah_modal_delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<script>
    $(document).ready(
            function() {
                $("#master_wilayah_list_btnadd").click(function() {
                    $("#master_wilayah_form_add").show("slow");
                    $("#master_wilayah_list").hide();
                });

                $(".master_wilayah_form_add_btncancel").click(function(e) {
                    e.preventDefault();
                    $("#master_wilayah_list").show("slow");
                    $("#master_wilayah_form_add").hide();
                    $("#master_wilayah_form_edit").hide();
                });

                $(".master_wilayah_list_btnedit").click(function(e) {
                    e.preventDefault();
                    $("#master_wilayah_form_edit").show("slow");
                    $("#master_wilayah_list").hide();
                });
