<%-- 
    Document   : form_edit_eproc_offline
...
<div class="col-md-12 eproc-offline-form-edit" style="display:none">
        <div class="block block-fill-white">
            ...
            <div class="content controls">
                <div class="form-row">
                    ...
                    <div class="col-md-5"><input type="Text" class="form-control" name="no_pengadaan" value="1234567"> </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2">Nama Pengadaan</div>
                    <div class="col-md-5"><input type="Text" class="form-control" name="nama_pengadaan" value="Pengadaan Laptop"> </div>
                </div> 
                <div class="form-row">
                    <div class="col-md-2">Tanggal Pengumuman / Undangan</div>
                    <div class="col-md-2"><input type="Text" class="datepicker form-control " value="08-10-2015" name="tanggal_pengadaan"> </div>
                </div>
                <div class="form-row">
                    <div class="col-md-2">No Dokumen / RKS</div>
                    <div class="col-md-3"><input type="Text" Placeholder="Nomor Dokumen / RKS" class="form-control" value="J083lUD" name="nama_pengadaan"> </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3"><input type="Text" class=" form-control" name="nilai_anggaran" value="4.000.000"> </div>
                </div>
                 <div class="form-row">
                    <div class="col-md-2">Nilai HPS (Harga Perkiraan Sendiri)</div>
                    <div class="col-md-3"><input type="Text" class=" form-control" name="nilai_hps" value="4.000.000"> </div>
                </div>
                 <div class="form-row">
                    <div class="col-md-2">Tahun Anggaran</div>
                    <div class="col-md-1"><input type="Text" class=" form-control" name="tahun_anggaran" value="2015"> </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" id="metode">
                            ...
                            <option selected="true">Jasa Konsultasi Perorangan</option>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3">
                        <select class="form-control" id="metode">
                            ...
                            <option selected="true">Pasca Kualifikasi</option>
                            <option>DPT</option>
                    ...
                    <div class="col-md-2">
                        <select class="form-control">
                            ...
                            <option selected="true">1 Sampul</option>
