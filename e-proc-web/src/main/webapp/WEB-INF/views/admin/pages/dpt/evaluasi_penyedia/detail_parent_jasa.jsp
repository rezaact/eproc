...
<div class="col-md-12 form_detail_parent_jasa" style="display:none;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><table>
                                    <tr>
                                        <td>
                                            <a  style="color:blue" class="link_pemasukan"><font color="Blue">Pemasukan Dokumen</font></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><a style="color:blue" class="link_print">Evaluasi</a></td>
                                    </tr>
                                    <tr>
                                        <td><a style="color:blue" class="link_print">Pembuktian Kualifikasi</a></td>
                                    </tr>
                                    <tr>
                                        <td><a style="color:blue" class="link_print">Penetapan Hasil</a></td>
                                    </tr>
                                </table></td>
                        </tr>
                    </tbody>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    Proses pendaftaran nomor DPT : DPT02072015-260 berhasil !!!
                </h4>
            </div>
