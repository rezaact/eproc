<%-- 
    Document   : setuju_ikut_lelang
    Created on : Oct 10, 2015, 7:53:39 PM
    Author     : Dawn
--%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@ taglib uri="http://tiles.apache.org/tags-tiles" prefix="tiles" %>
<div class="res_ikut_lelang div_hide">
<div class="col-md-12">
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr bgcolor="#ffff99">
                                                ...
                                                <td align="right"><a href="javascript:void(0);" id="btn_kirim_penjelasan"><b class="text_red">[Kirim Penjelasan]</b></a></td>
                                            </tr>
                                        </tbody>
                                    </table> 
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr bgcolor="#ffff99">
                                                <td width="40%">Jadwal : 18-08-2015 09:00 - 19-08-2015 14:00</td> 
                                                <td align="right"><a href="javascript:void(0);" id="btn_evaluasi_harga"><b class="text_red">[ Evaluasi Harga ]</b></a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                ...
                                <td colspan="3">
                                    ...
                                    <form method="post" action="">
                                        <table class="table-hover table">
                                            ...
                                            <tr>
                                                <td>Data Kualifikasi
                                                    <button type="submit" class="btn btn-primary btn-label-left btn_kirim_dokumen_kualifikasi">
...
<script>
    ...
    $(document).on('click','#btn_kirim_penjelasan',function(e){
        e.preventDefault();
        console.log('show kirim penjelasan');
        $(".form_kirim_penjelasan_div").show("slow"); 
        $(".res_ikut_lelang").hide();
        /*$.ajax({
            url: BASE_URL + "penyedia/kirim_penjelasan",
            type: 'get',
            dataType: 'html',
            data: {},
            success: function(data){
                $(".res_ikut_lelang").empty();
                $(".res_ikut_lelang").html(data);
             }
        })
        .done(function() {
            console.log("success");
    ...
    $(document).on('click','#btn_evaluasi_harga',function(e){
        e.preventDefault();
        console.log('show evaluasi harga');
        $(".form_action_view_div").show("slow"); 
        $(".res_ikut_lelang").hide();
        
        /*$.ajax({
                url: BASE_URL + "penyedia/auction_view",
                type: 'get',
                dataType: 'html',
                data: {},
                success: function(data){
    ...
    $(document).on('click','.btn_kirim_dokumen_kualifikasi',function(e){
        e.preventDefault();
        /*$(".res_ikut_lelang").empty();
        $(".res_ikut_lelang").load( BASE_URL + "penyedia/open_syarat").show("slow");*/
