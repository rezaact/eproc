...
<!--START HTML-->
<!-- START LIST BIDANG-->
<div class="col-md-12" id="master_bidang_list">
    <div class="block block-fill-white">
        <div class="header" style="background-color:SteelBlue;"><h2 style="color:white;font-size:14px">Master Bidang</h2>
            <div class="pull-right"><a id="master_bidang_list_btnadd" class="btn btn-success">
...
<!--END FORM LIST BIDANG-->

<!-- START FORM TAMBAH BIDANG-->
<div class="col-md-12" id="master_bidang_form_add" style="display: none">
    <div class="block block-fill-white">
        <div class="panelx panel-info">
            <div class="panel-heading"><h3 class="panel-title">TAMBAH BIDANG</h3>
            </div>
            <form method="post" action="#">
                <div class="panel-body">
                    <div class="content controls">
                        ...
                        <div class="form-row">
                            <div class="col-md-2">Nama Bidang</div>
                            <div class="col-md-2">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                ...
                                <button class="btn btn-danger master_bidang_form_add_btncancel"><span class="icon-repeat"></span> Kembali</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--END FORM TAMBAH BIDANG-->

<!-- START FORM EDIT -->
<div class="col-md-12" id="master_bidang_form_edit" style="display: none">
    <div class="block block-fill-white">
        <div class="panelx panel-info">
            <div class="panel-heading"><h3 class="panel-title">PERBAHARUI BIDANG</h3>
            </div>
            <form method="post" action="#">
                <div class="panel-body">
                    <div class="content controls">
                        ...
                        <div class="form-row">
                            <div class="col-md-2">Nama Bidang</div>
                            <div class="col-md-2">
                                <input type="text" maxlength="50" class="form-control" value="Pengadaan Barang"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-2">Keterangan</div>
...
<!--START HTML MODAL-->
<div class="modal" id="master_bidang_modal_delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    $(document).ready(
            function() {
                ...
                $(".master_bidang_list_btnedit").click(function(e) {
                    e.preventDefault();
                    $("#master_bidang_form_edit").show("slow");
                    $("#master_bidang_list").hide();
                });
