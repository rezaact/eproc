...
@XmlRootElement(name = "IPGetRefSubBidang")
public class IPGetRefSubBidang {

    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_get_ref_sub_bidang", type = JAXBElement.class, required = false)
