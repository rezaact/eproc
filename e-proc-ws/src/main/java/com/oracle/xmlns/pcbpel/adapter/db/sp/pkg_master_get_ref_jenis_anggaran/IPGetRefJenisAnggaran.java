...
@XmlRootElement(name = "IPGetRefJenisAnggaran")
public class IPGetRefJenisAnggaran {

    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_get_ref_jenis_anggaran", type = JAXBElement.class, required = false)
