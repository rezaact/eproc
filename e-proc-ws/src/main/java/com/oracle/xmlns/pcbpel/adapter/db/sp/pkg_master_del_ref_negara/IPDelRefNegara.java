...
@XmlRootElement(name = "IPDelRefNegara")
public class IPDelRefNegara {

    @XmlElementRef(name = "P_KODE_NEGARA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_del_ref_negara", type = JAXBElement.class, required = false)
