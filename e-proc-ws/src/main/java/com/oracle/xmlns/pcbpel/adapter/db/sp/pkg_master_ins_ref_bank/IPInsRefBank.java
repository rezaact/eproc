...
@XmlRootElement(name = "IPInsRefBank")
public class IPInsRefBank {

    @XmlElementRef(name = "P_KODE_NEGARA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pkodenegara;
    @XmlElementRef(name = "P_KODE_BANK", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pkodebank;
    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pnama;
    @XmlElementRef(name = "P_CABANG", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pcabang;
    @XmlElementRef(name = "P_ALAMAT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<String> palamat;
    @XmlElementRef(name = "P_KOTA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pkota;
    @XmlElementRef(name = "P_FLAG_TAMPIL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pflagtampil;
    @XmlElementRef(name = "P_CREATE_BY", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bank", type = JAXBElement.class, required = false)
