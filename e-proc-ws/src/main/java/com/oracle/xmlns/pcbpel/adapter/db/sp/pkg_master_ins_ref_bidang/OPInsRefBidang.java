...
@XmlRootElement(name = "OPInsRefBidang")
public class OPInsRefBidang {

    @XmlElementRef(name = "OUT_ROWCOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bidang", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> outrowcount;
    @XmlElementRef(name = "MSGERROR", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_bidang", type = JAXBElement.class, required = false)
