...
@XmlRootElement(name = "IPGetRefKbli")
public class IPGetRefKbli {

    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_get_ref_kbli", type = JAXBElement.class, required = false)
