...
@XmlRootElement(name = "IPInsRefDana")
public class IPInsRefDana {

    @XmlElementRef(name = "P_NAMA_DANA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dana", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pnamadana;
    @XmlElementRef(name = "P_SUMBER_LOAN", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dana", type = JAXBElement.class, required = false)
    protected JAXBElement<String> psumberloan;
    @XmlElementRef(name = "P_NO_SUMBER_DANA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dana", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pnosumberdana;
    @XmlElementRef(name = "P_KETERANGAN", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dana", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pketerangan;
    @XmlElementRef(name = "P_FLAG_TAMPIL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dana", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pflagtampil;
    @XmlElementRef(name = "P_CREATE_BY", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dana", type = JAXBElement.class, required = false)
