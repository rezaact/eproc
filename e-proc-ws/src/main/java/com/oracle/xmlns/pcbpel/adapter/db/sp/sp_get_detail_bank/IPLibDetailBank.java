...
@XmlRootElement(name = "IP_Lib_Detail_Bank")
public class IPLibDetailBank {

    @XmlElementRef(name = "IN_KODE_BANK", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/sp_get_detail_bank", type = JAXBElement.class, required = false)
