...
public class InputParameters {
    ...
    @XmlElementRef(name = "IN_ID_USER", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/scm_getlist_menu_id_user_clob", type = JAXBElement.class, required = false)
