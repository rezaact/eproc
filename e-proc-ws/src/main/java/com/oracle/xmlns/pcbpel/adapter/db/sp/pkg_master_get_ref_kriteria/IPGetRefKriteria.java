...
@XmlRootElement(name = "IPGetRefKriteria")
public class IPGetRefKriteria {

    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_get_ref_kriteria", type = JAXBElement.class, required = false)
