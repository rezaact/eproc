...
@XmlRootElement(name = "IPDelRefBadanUsaha")
public class IPDelRefBadanUsaha {

    @XmlElementRef(name = "P_ID_BADAN_USAHA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_del_ref_badan_usaha", type = JAXBElement.class, required = false)
