...
@XmlRootElement(name = "OPDelRefBank")
public class OPDelRefBank {

    @XmlElementRef(name = "OUT_ROWCOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_del_ref_bank", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> outrowcount;
    @XmlElementRef(name = "MSGERROR", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_del_ref_bank", type = JAXBElement.class, required = false)
