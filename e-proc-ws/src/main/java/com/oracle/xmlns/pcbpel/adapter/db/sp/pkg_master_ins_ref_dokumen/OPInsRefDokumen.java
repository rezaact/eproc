...
@XmlRootElement(name = "OPInsRefDokumen")
public class OPInsRefDokumen {

    @XmlElementRef(name = "OUT_ROWCOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dokumen", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> outrowcount;
    @XmlElementRef(name = "MSGERROR", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dokumen", type = JAXBElement.class, required = false)
