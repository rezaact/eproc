...
@XmlRootElement(name = "IPGetRefBadanUsaha")
public class IPGetRefBadanUsaha {

    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_get_ref_badan_usaha", type = JAXBElement.class, required = false)
