...
@XmlRootElement(name = "IPInsRefDokumen")
public class IPInsRefDokumen {

    @XmlElementRef(name = "P_NAMA_DOKUMEN", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dokumen", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pnamadokumen;
    @XmlElementRef(name = "P_PATH_FILE", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dokumen", type = JAXBElement.class, required = false)
    protected JAXBElement<String> ppathfile;
    @XmlElementRef(name = "P_KETERANGAN", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dokumen", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pketerangan;
    @XmlElementRef(name = "P_FLAG_TAMPIL", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dokumen", type = JAXBElement.class, required = false)
    protected JAXBElement<String> pflagtampil;
    @XmlElementRef(name = "P_CREATE_BY", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_dokumen", type = JAXBElement.class, required = false)
