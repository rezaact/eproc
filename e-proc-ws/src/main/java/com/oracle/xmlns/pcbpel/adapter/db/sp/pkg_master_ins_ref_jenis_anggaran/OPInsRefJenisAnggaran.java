...
@XmlRootElement(name = "OPInsRefJenisAnggaran")
public class OPInsRefJenisAnggaran {

    @XmlElementRef(name = "OUT_ROWCOUNT", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_jenis_anggaran", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> outrowcount;
    @XmlElementRef(name = "MSGERROR", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_ins_ref_jenis_anggaran", type = JAXBElement.class, required = false)
