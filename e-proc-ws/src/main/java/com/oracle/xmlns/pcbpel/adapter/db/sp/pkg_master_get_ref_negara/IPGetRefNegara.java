...
@XmlRootElement(name = "IPGetRefNegara")
public class IPGetRefNegara {

    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_get_ref_negara", type = JAXBElement.class, required = false)
