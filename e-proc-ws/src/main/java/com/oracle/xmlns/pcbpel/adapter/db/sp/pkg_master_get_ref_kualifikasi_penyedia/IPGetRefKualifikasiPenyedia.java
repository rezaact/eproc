...
@XmlRootElement(name = "IPGetRefKualifikasiPenyedia")
public class IPGetRefKualifikasiPenyedia {

    @XmlElementRef(name = "P_NAMA", namespace = "http://xmlns.oracle.com/pcbpel/adapter/db/sp/pkg_master_get_ref_kualifikasi_penyedia", type = JAXBElement.class, required = false)
